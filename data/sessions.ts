...
export const sessions: Session[] = [
  ...
  { id: "1B", unit: 1, letter: "B", title: "Three story shapes", focus: "Find a missing whole, missing part, or missing start.", activity: "Draw the same part-whole box for six different stories.", success: "The student decides what is missing without relying on keywords.", kind: "Core", expectations: ["B2.1", "B2.4"] },
  ...
  { id: "1D", unit: 1, letter: "D", title: "Cross the ten", focus: "Add past ten by making the ten first.", activity: "Move counters into a ten frame, then read the answer as ten and some ones.", success: "The student says the total, not the leftover.", kind: "Core", expectations: ["B2.2", "B2.3"] },
  ...
  { id: "8B", unit: 8, letter: "B", title: "Half of odd totals", focus: "Extend halving to two-digit odd numbers.", activity: "Use strips or counters before writing mixed-number answers.", success: "The student can model the remaining one half physically.", kind: "Extension", expectations: [] },
  ...
  { id: "10A", unit: 10, letter: "A", title: "Build and break shapes", focus: "Compose and decompose shapes, and see that the area stays the same.", activity: "Rearrange the same tangram or pattern-block pieces into different outlines.", success: "The student says the amount of space is unchanged when pieces move.", kind: "Core", expectations: ["E1.2"] },
  ...
  { id: "11C", unit: 11, letter: "C", title: "The broken ruler", focus: "Measure and draw in centimetres and metres, including from a non-zero start.", activity: "Measure objects lined up at the 3 mark, then draw lines to a given length.", success: "The student accounts for the starting point instead of reading the end number.", kind: "Core", expectations: ["E2.3"] },

  { id: "12A", unit: 12, letter: "A", title: "Map the home", focus: "Create and interpret a simple map of a familiar place.", activity: "Draw a bird's-eye map of one room, then use it to find a hidden object.", success: "The student places objects in the right relative positions on the map.", kind: "Core", expectations: ["E1.4"] },
  ...
  { id: "13A", unit: 13, letter: "A", title: "Canadian coins", focus: "Recognize coins and compare their values.", activity: "Sort real coins by value, not physical size.", success: "The student identifies each coin and explains its value.", kind: "Core", expectations: ["F1.1"] },
  { id: "13B", unit: 13, letter: "B", title: "Equivalent amounts", focus: "Represent the same amount in different ways, in coins and in bills.", activity: "Make 60 cents several ways, then make 75 dollars several ways.", success: "The student creates and verifies more than one combination.", kind: "Core", expectations: ["F1.1"] },

  { id: "14A", unit: 14, letter: "A", title: "Count up for change", focus: "Apply number sense to simple cash change.", activity: "Count from a price to the amount paid using real coins.", success: "The student counts up and verifies the total paid.", kind: "Extension", expectations: [] },
  ...
  { id: "20B", unit: 20, letter: "B", title: "Write and run code", focus: "Create a computational representation and execute it.", activity: "Build a short block program that draws a shape or moves a character.", success: "The student predicts the outcome before running the code.", kind: "Core", expectations: ["C3.1"] },
  ...
  { id: "22A", unit: 22, letter: "A", title: "Fair sharing", focus: "Share up to 12 items among two, three, four, or six people.", activity: "Use counters and discuss equal shares and leftovers.", success: "The student checks that every share is equal.", kind: "Core", expectations: ["B1.6", "B2.6"] },
  { id: "22B", unit: 22, letter: "B", title: "Thirds and sixths", focus: "Recognize that one third and two sixths of the same whole are equal.", activity: "Fold identical strips into thirds and into sixths, then lay them side by side.", success: "The student shows the two amounts are equal using the same whole.", kind: "Core", expectations: ["B1.7"] },
  { id: "22C", unit: 22, letter: "C", title: "Odd, even, skip count", focus: "Describe what makes a number even or odd and count by useful intervals.", activity: "Pair counters, predict leftovers, then count by 2, 5, 10, and 25.", success: "The student predicts odd or even before building the pairs.", kind: "Core", expectations: ["B1.4", "B1.5"] },

  { id: "23A", unit: 23, letter: "A", title: "Sort two ways at once", focus: "Sort a set by two attributes using Venn and Carroll diagrams.", activity: "Sort buttons or books by two rules and argue about the overlap.", success: "The student places an item in the overlap and explains why it belongs there.", kind: "Core", expectations: ["D1.1"] },
