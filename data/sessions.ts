...
export const sessions: Session[] = [
  ...
  { id: "1B", unit: 1, letter: "B", title: "Three story shapes", focus: "Find a missing whole, missing part, or missing start.", activity: "Draw the same part-whole box for six different stories.", success: "The student decides what is missing without relying on keywords.", kind: "Core", expectations: ["B2.1", "B2.4"], extraPractice: { focus: "Seven more stories, weighted toward the missing-start type, for a student who guessed at keywords instead of reasoning from the box." } },
